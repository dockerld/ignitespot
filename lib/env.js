...
export const QBO_INVITE_WEBHOOK_SECRET =
  process.env.QBO_INVITE_WEBHOOK_SECRET || "";
export const NOTION_TOKEN = process.env.NOTION_TOKEN || "";
export const NOTION_CLIENT_NAMES_DB_ID =
  process.env.NOTION_CLIENT_NAMES_DB_ID || "";
export const NOTION_CLIENT_SOFTWARE_DB_ID =
  process.env.NOTION_CLIENT_SOFTWARE_DB_ID || "";

export function logEnvStatus() {
  console.log("✅ Booting Ignite BlazeBot...");
  ...
  console.log(
    ...
    !!NOTION_TOKEN && !!NOTION_CLIENT_NAMES_DB_ID && !!NOTION_CLIENT_SOFTWARE_DB_ID
  );
}
